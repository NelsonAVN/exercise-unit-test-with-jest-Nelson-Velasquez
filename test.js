...
test("One dollar should be 146.3 yen", function() {
    // Import the function from app.js
...
test("One yen should be 0.005559105431309904 pounds", function() {
    ...
    // This is the comparison for the unit test
     expect(fromYenToPound(1)).toBe(0.005559105431309904); // 1 euro is 1.07 dollars, then 3.5 euros should be = (3.5 * 1.07)
})